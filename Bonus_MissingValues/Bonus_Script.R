...
#Create a flag variable for each missing numeric variable. The variable name should begin with "M_" as 
#it was in the video.
...
#Create an imputed variable for each numeric variable that has a missing value. Fill in the missing 
#value with the mean. The variable name should begin with "IMP_" as it was in the video.
...
#Create an imputed variable for each categorical variable that has a missing value. Fill in the 
...
#Identify any outliers and fix them in a method similar to those presented in the video.
